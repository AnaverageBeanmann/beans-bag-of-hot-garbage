...
--------------------------------------------------*/
-- ENT.SoundTbl_Startup = {"fx/COCA_COLA_ESPUMA.mp3"}
ENT.SoundTbl_OnCollide = {"physics/metal/soda_can_impact_hard1.wav",
...
function ENT:CustomOnPreInitialize()
	local StartSound = math.random(1,3)
	if StartSound == 1 then
		self.SoundTbl_Startup = {"fx/WE_HAVE_PEPSI.mp3"}
		self.FussTime = 2.7
	elseif StartSound == 2 then
		self.SoundTbl_Startup = {"fx/ARBYS_MESSED_UP.mp3"}
		self.FussTime = 5.4
	elseif StartSound == 3 then
		self.SoundTbl_Startup = {"fx/p_e_p_s_i.mp3"}
		self.FussTime = 3.95
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
