...
ENT.DirectDamage = math.random(5,10) -- How much damage should it do when it hits something
...
ENT.IdleSoundPitch = VJ_Set(125, 150)
ENT.OnCollideSoundPitch = VJ_Set(110, 125)
